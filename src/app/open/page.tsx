...
export default function OpenTicket() {
    ...
    return (
        <div className="max-w-screen-md max-w-2xl mx-auto px-2">
                    ...
                    >
                        <div className="flex flex-col gap-3">
                            ...
                            <button
                                ...
                                disabled={loading}
                            >
                                {loading ? <ImSpinner10 className="animate-spin" size={24}/> : "Procurar cliente"}
                                {!loading && (<FiSearch size={24} color="#FFF"/>)}
                            </button>
                        </div>
                    </form>
                )}
